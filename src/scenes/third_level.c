...
void	*third_level_init(t_context *context, SDL_UNUSED void *vp_scene)
{
	t_third_level	*scene;

	scene = new_scene(sizeof(*scene), context, ASSETS"level_one.png", third_level_close, third_level_update);
